...
%  2pi-periodic panelization given by breakpoints tpan and panel quadratures
...
%  in s<t and in s>t, but may be discontinuous on the diagonal s=t.
%
...
%        and the last (npan+1)th must be 2pi, for now (simplifies wrapping).
...
%      values of a 2pi-periodic function u(t) on all nodes to values of
%      (Ku)(t) := int_0^2pi k(t,s) u(s) ds at these same nodes.
% 
